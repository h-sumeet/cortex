...
## Business purpose:
The application manages IT exam topics for various content providers like Google Cloud, Microsoft, AWS, and CompTIA. Each provider offers a set of topics, and each topic contains multiple questions. The system tracks the number of topics per provider and the number of questions per topic, facilitating efficient management, retrieval of exam content and filtering by provider or topic and sequence no.